// cinetpay_deces_deja.js
function initiateCinetPayPaymentDecesDeja(formData, form) {
    ...
    CinetPay.setConfig({
        ...
        notify_url: 'https://votredomaine.com/notify', // URL de notification (à modifier)
    ...
    CinetPay.getCheckout({
        ...
        currency: 'XOF',
        channels: 'ALL',
        description: 'Paiement pour la livraison de l\'acte de décès (déjà enregistré)',
