...
<html>
<head>
    <title>Plateau-Apps - Mise à jour du mot de passe Service de Livraison</title>
</head>
<body>
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="padding: 20px; font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <p>La Mairie a demandé la mise à jour du mot de passe de votre compte Service de Livraison (Poste).</p>
                ...
                <p style="margin-top: 30px;">
                    <a href="{{ url('/validate-post-account/' . $email) }}" style="background-color: #6777ef; border: none; color: white; padding: 12px 25px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; cursor: pointer; border-radius: 5px; font-weight: bold;">
