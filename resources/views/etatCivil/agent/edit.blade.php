        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card shadow-lg border-0 rounded-20">
                <div class="card-header py-4 text-center bg-gradient-primary rounded-top-20">
                    <h2 class="mb-0 fw-bold text-white"><i class="fas fa-edit me-2 text-white"></i>Modification de l'agent d'État Civil</h2>
                    <p class="mb-0 mt-2 opacity-75 text-white">Modification des informations de l'agent</p>
                </div>
                ...
                <div class="card-body px-4 px-md-5 py-4">
                    ...
                    <form method="POST" action="{{ route('agents.update', $agent->id) }}" enctype="multipart/form-data" id="editForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="step-content" id="step1">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $agent->name) }}" required 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light"><i class="fas fa-user" style="color:#1977cc"></i></span>
                                        <input type="text" class="form-control rounded-end @error('prenom') is-invalid @enderror" id="prenom" name="prenom" value="{{ old('prenom', $agent->prenom) }}" required 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control rounded-end @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $agent->email) }}" required 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ old('contact', $agent->contact) }}" required 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light"><i class="fas fa-phone" style="color:#1977cc"></i></span>
                                        <input type="text" class="form-control rounded-end @error('cas_urgence') is-invalid @enderror" id="cas_urgence" name="cas_urgence" value="{{ old('cas_urgence', $agent->cas_urgence) }}" required 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end @error('commune') is-invalid @enderror" id="commune" name="commune" value="{{ old('commune', $agent->commune) }}" required 
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('etat_civil.agent.state.index') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="step-content d-none" id="step2">
                            ...
                            <div class="row mb-4">
                                <div class="col-12 text-center">
                                    <p class="fw-medium">Photo actuelle :</p>
                                    <img src="{{ asset('storage/' . $agent->profile_picture) }}" alt="Photo actuelle" class="rounded-circle shadow" width="120" height="120">
                                    <p class="text-muted mt-2">Photo actuelle de l'agent</p>
                                </div>
                            </div>
                            @endif
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="file-upload-container text-center">
                                        ...
                                        <label for="profile_picture" class="file-upload-label">
                                            ...
                                            <h5>Glissez-déposez votre nouvelle photo ou cliquez pour parcourir</h5>
                                            <p class="text-muted">Format JPG, PNG ou GIF - Max 2MB</p>
                                            <p class="text-info small">Laissez vide pour conserver la photo actuelle</p>
                                        </label>
                        ...
                        <div class="step-content d-none" id="step3">
                            <div class="mb-4">
                                <h4 class="border-bottom pb-2" style="color:#1977cc"><i class="fas fa-check-circle me-2"></i>Confirmation des modifications</h4>
                            </div>
                            ...
                            <div class="confirmation-summary bg-light rounded-15 p-4 mb-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p id="summary-name" class="text-muted mb-3">{{ $agent->prenom }} {{ $agent->name }}</p>
                                        
                                        <p class="fw-medium">Email:</p>
                                        <p id="summary-email" class="text-muted mb-3">{{ $agent->email }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="fw-medium">Téléphone:</p>
                                        <p id="summary-contact" class="text-muted mb-3">{{ $agent->contact }}</p>
                                        
                                        <p class="fw-medium">Contact d'urgence:</p>
                                        <p id="summary-cas-urgence" class="text-muted mb-3">{{ $agent->cas_urgence }}</p>
                                        
                                        <p class="fw-medium">Commune:</p>
                                        <p id="summary-commune" class="text-muted mb-3">{{ $agent->commune }}</p>
                                    </div>
                                </div>
                                <div class="text-center mt-3" id="summary-photo-container">
                                    <p class="fw-medium">Photo de profil:</p>
                                    <div id="summary-photo" class="d-inline-block">
                                        @if($agent->profile_picture)
                                            <img src="{{ asset('storage/' . $agent->profile_picture) }}" alt="Photo actuelle" class="preview-image rounded-circle shadow" width="100" height="100">
                            ...
                            <div class="form-check mb-4">
                                ...
                                <label class="form-check-label" for="confirmationCheck">
                                    Je confirme que les modifications ci-dessus sont correctes
                                </label>
                            </div>
...
<!-- Inclure le même CSS et JavaScript que la vue de création -->
<style>
    /* Reprendre le même CSS que la vue de création */
    :root {
        --primary: #1977cc;
        --secondary: #1977cc;
        --light-bg: #f8f9fa;
    ...
    .btn-success:hover {
        background: linear-gradient(135deg, #3781c2 0%, #3781c2 100%);
        transform: translateY(-2px);
...
<script>
    // Reprendre le même JavaScript que la vue de création
