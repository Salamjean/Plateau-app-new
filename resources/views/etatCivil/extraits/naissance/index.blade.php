...
@section('content')
    ...
    <div class="dashboard-container">
        <div class="page-title">
            <h2><i class="fas fa-baby me-2"></i>Demandes d'extraits de naissance</h2>
        ...
        <div class="filter-section">
            <form method="GET" action="{{ route('etat_civil.request.birth') }}" class="filter-form">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse($naissances as $naissance)
                            <tr>
                                <td data-label="Référence"><span class="id-badge">{{ $naissance->reference }}</span></td>
                                <td data-label="Demandeur">
                                    <div class="user-info-cell">
                                        <div class="user-avatar-small">{{ substr($naissance->user->name ?? 'U', 0, 1) }}
                                        </div>
                                        <span class="user-name">{{ $naissance->user->name ?? 'N/A' }}</span>
                                    </div>
                                </td>
                                <td data-label="Type">
                                    <span class="fw-600">{{ $naissance->type == 'simple' ? 'Simple' : 'Intégrale' }}</span>
                                </td>
                                <td data-label="Quantité">{{ $naissance->quantite }} copie(s)</td>
                                <td data-label="Date">{{ $naissance->created_at->format('d/m/Y') }}</td>
                                <td data-label="État">
                                    <span class="status-badge status-{{ str_replace(' ', '-', $naissance->etat) }}">
                                        {{ ucfirst($naissance->etat) }}
                                    </span>
                                </td>
                                ...
                                <td data-label="Agent">
                                    <span class="text-muted">{{ $naissance->agent->name ?? '---' }}</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
