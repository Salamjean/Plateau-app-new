                            ...
                            <tr>
                                ...
                                <td data-label='Demandeur'>
                                    <div class='user-info-cell'>
                                        ...
                                        <div class='user-data'>
                                            <span class='user-name'>{{ $task->user->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td data-label='Type'>
                                ...
                                <td data-label='Date'>{{ $task->created_at ? $task->created_at->format('d/m/Y') : '' }}
                                </td>
                                <td data-label='Statut'>
                                    <div class='status-pill'>
                                        <i class='fas fa-check-circle'></i> {{ $task->status ?? 'Traité' }}
                                    </div>
                                </td>
                                <td data-label='Agent'>
                                    <span class='text-muted'><i
                                            class='fas fa-user-tie me-1'></i>{{ $task->agent->name ?? 'Agent' }}</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
