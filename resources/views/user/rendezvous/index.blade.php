...
@section('content')
    ...
    <div class="row flex-grow dashboard-final animate__animated animate__fadeIn">
                                    ...
                                    <tr class="animate__animated animate__fadeIn">
                                        <td class="text-center" style="text-align: center">
                                            <div style="text-align: center">
                                                ...
                                                <div class="text-center" style="text-align: center">
                                                    <h6 class="mb-1 text-muted">Nom: <span
                                                            class="text-black">{{ $item->nom_epoux . ' ' . $item->prenom_epoux }}
                                                        </span></h6>
                                                    <h6 class="mb-1 text-muted">Date Naiss: <span
                                                            class="text-black">{{ $item->date_naissance_epoux }} </span></h6>
                                                    <small class="mb-1 text-muted">Lieu Naiss: <span
                                                            class="text-black">{{ $item->lieu_naissance_epoux }} </span></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center" style="text-align: center">
                                            <div style="text-align: center">
                                                ...
                                                <div class="text-center" style="text-align: center">
                                                    <h6 class="mb-1 text-muted">Nom: <span
                                                            class="text-black">{{ $item->nom_epouse . ' ' . $item->prenom_epouse }}
                                                        </span></h6>
                                                    <h6 class="mb-1 text-muted">Date Naiss: <span
                                                            class="text-black">{{ $item->date_naissance_epouse }} </span></h6>
                                                    <small class="mb-1 text-muted">Lieu Naiss: <span
                                                            class="text-black">{{ $item->lieu_naissance_epouse }}</span></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center" style="text-align: center">
                                            <div style="text-align: center">
                                                ...
                                                <div class="text-center" style="text-align: center">
                                                    <h6 class="mb-1 text-muted">Adresse: <span
                                                            class="text-black">{{ $item->adresse }}</span></h6>
                                                    <h6 class="mb-1 text-muted">Contact: <span
                                                            class="text-black">{{ $item->telephone }}</span></h6>
                                                    <small class="mb-1 text-muted">Email: <span
                                                            class="text-black">{{ $item->email }}</span></small>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center" style="text-align: center">
                                            <div style="text-align: center">
                                                ...
                                                <div class="text-center" style="text-align: center">
                                                    <h6 class="mb-1 text-muted">Date: <span
                                                            class="text-black">{{ $item->date_mariage_souhaitee }}</span></h6>
                                                    <h6 class="mb-1 text-muted">Heure: <span
                                                            class="text-black">{{ $item->heure_souhaitee }}</span></h6>
                                                    <h6 class="mb-1 text-muted">Motif: <span
                                                            class="text-black">{{ Str::limit($item->motif, 20) }}</span></h6>
                                                    @php
                                                        $badgeClasses = [
