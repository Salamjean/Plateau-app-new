                ...
                <script>
                    function onMariageTypeChange(input) {
                        ...
                        if (val === 'groupee') {
                            ...
                            qtyIntegral.min = '1';
                            if (parseInt(qtySimple.value) < 1) qtySimple.value = 1;
                            if (parseInt(qtyIntegral.value) < 1) qtyIntegral.value = 1;
                            ...
                            qtyIntegral.value = 0;
                            if (parseInt(qtySimple.value) < 1) qtySimple.value = 1;
                            document.getElementById('mQtySimpleMinus').disabled = (parseInt(qtySimple.value) <= 1);
                            ...
                            qtySimple.value = 0;
                            if (parseInt(qtyIntegral.value) < 1) qtyIntegral.value = 1;
                            document.getElementById('mQtyIntegralMinus').disabled = (parseInt(qtyIntegral.value) <= 1);
                            row.classList.remove('dual-card');
                            row.classList.add('single-card');
                            if (label) label.innerHTML =
                                '<i class="fas fa-copy" style="color:var(--primary);"></i> Combien de copies souhaitez-vous ?';
