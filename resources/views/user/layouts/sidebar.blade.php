<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <p class="nav-section-title">Historique</p>
        ...
        <li class="{{ request()->routeIs('user.pending.collections') ? 'active' : '' }} item-collections">
            <a href="{{ route('user.pending.collections') }}">
                <i class="fas fa-truck-ramp-box"></i> <span>Retraits & Livraisons</span>
            </a>
        </li>
