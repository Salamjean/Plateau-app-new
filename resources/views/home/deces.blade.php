            ...
            <div class="container text-center">
                <div class="badge-service mb-3" data-aos="fade-down">
                    <span class="badge rounded-pill bg-white bg-opacity-25 text-white px-3 py-2 fw-700">
                        <i class="bi bi-clock-history me-1"></i> ÉTAT CIVIL
                    </span>
                </div>
                <h1 class="display-3 fw-900 text-white mb-4" data-aos="fade-up">Extraits de Décès</h1>
                <p class="lead text-white-50 mx-auto" style="max-width: 700px;" data-aos="fade-up" data-aos-delay="100">
                    Facilitez vos démarches administratives en commandant vos actes de décès en ligne. Un service sécurisé
                    et respectueux.
                </p>
            </div>
        </section>
                                ...
                                <div class="p-5">
                                    <div class="row g-5">
                                        <div class="col-md-7">
                                            ...
                                            <p class="text-muted fs-5 mb-4">Pour obtenir un extrait d'acte de décès standard
                                                contenant les informations essentielles.</p>

                                            <div class="alert-modern mb-4">
                                                <i class="bi bi-info-circle-fill text-primary fs-4"></i>
                                                <div>
                                                    <span class="fw-800 d-block text-primary">Usage courant</span>
                                                    <span class="small text-muted">Ce document est utilisé pour la plupart
                                                        des formalités administratives et bancaires.</span>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-unstyled custom-list">
                                                <li><i class="bi bi-check-circle-fill text-success"></i> Nom et prénoms
                                                    complets du défunt</li>
                                                <li><i class="bi bi-check-circle-fill text-success"></i> Date et lieu du
                                                    décès</li>
                                                <li><i class="bi bi-check-circle-fill text-success"></i> Numéro d'acte et
                                                    année du registre</li>
                                                <li><i class="bi bi-check-circle-fill text-success"></i> Identité du
                                                    demandeur</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-5">
                                ...
                                <div class="p-5">
                                    <div class="row g-5">
                                        <div class="col-md-7">
                                            ...
                                            <p class="text-muted fs-5 mb-4">Une reproduction exhaustive de l'acte original
                                                avec l'ensemble des mentions marginales.</p>
                                            ...
                                            <div class="alert-modern info mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="small text-muted">Nécessaire pour les successions complexes
                                                        ou les démarches notariales spécifiques.</span>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-unstyled custom-list">
                                                <li><i class="bi bi-check-circle-fill text-success"></i> Références
                                                    exhaustives de l'acte original</li>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-4">
                        <div class="faq-card p-4 bg-white rounded-4 shadow-sm h-100 transition border-0">
                            <h4 class="fw-800 text-primary mb-3">Qui peut déclarer ?</h4>
                            <p class="text-muted mb-0">Toute personne disposant des renseignements les plus exacts sur
                                l'état civil du défunt (proche, pompes funèbres, etc.).</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="faq-card p-4 bg-white rounded-4 shadow-sm h-100 transition border-0">
                    ...
                    <div class="col-md-4">
                        <div class="faq-card p-4 bg-white rounded-4 shadow-sm h-100 transition border-0">
                            ...
                            <p class="text-muted mb-0">Vous pouvez FAIRE une demande de duplicata ou un nouvel extrait à tout moment
