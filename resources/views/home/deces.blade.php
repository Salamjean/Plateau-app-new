                ...
                <div class="extrait-card">
                    ...
                    <div class="card-body">
                        <div class="info-alert">
                            ...
                            <div>
                                <strong>Important :</strong> Vous devez disposer d'un certificat médical de décès délivré
                                par l'hôpital ou le médecin ayant constaté le décès.
                            </div>
                        </div>

                        <div class="description">
                            <p>Pour faire une demande d'extrait de décès, un certificat médical de décès est nécessaire. Ce
                                document officiel est délivré par l'hôpital ou le médecin ayant constaté le décès. Veuillez
                                vous assurer que vous disposez de ce document avant d'effectuer votre demande.</p>
                        </div>
            ...
            <div class="tab-content active" id="simple-integral">
                <div class="extrait-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="description">
                            <p>L'acte de décès peut donner lieu à la délivrance de 2 documents différents : <strong>la copie
                                    intégrale</strong> et <strong>l'extrait simple</strong>. La copie intégrale comporte des
                                informations complètes sur la personne concernée (nom, prénoms, date et lieu de décès), des
                                informations sur ses parents et les mentions marginales lorsqu'elles existent. L'extrait
                                simple contient uniquement les informations de base sur la personne concernée.</p>
                        </div>
            ...
            <div class="extrait-container">
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        ...
                        <p>L'extrait simple contient les informations de base (nom, prénoms, date et lieu de décès) tandis
                            que la copie intégrale inclut également des informations sur les parents et les mentions
                            marginales.</p>
                    </div>
                    <div class="faq-item">
