...
<style>
    ...
    table th { background-color: #1977cc ; font-weight: 600; color: white }
    ...
    <div class="recent-activity">
        ...
        @else
            <table>
                <thead>
                    <tr>
                        <th class="text-center">Livraison code</th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    data: {
        ...
        datasets: [
            { label: 'Livrés', data: @json($chartData['livre']), backgroundColor: '#1977cc' },
            { label: 'En cours', data: @json($chartData['en_cours']), backgroundColor: '#ea8c51' }
        ]
    },
    options: {
        responsive: true,
    ...
    new Chart(document.getElementById('typeChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#1977cc', '#ea8c51', '#d4a700']
            }]
        },
