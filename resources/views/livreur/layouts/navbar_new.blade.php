    ...
    <div class="navbar-left">
        ...
        <div class="navbar-brand">
            ...
            <div class="brand-text">
                <h1 class="brand-title">Espace Livreur</h1>
                <span class="brand-subtitle">Plateau Distribution</span>
            </div>
        </div>
    </div>
        ...
        <div class="navbar-profile-wrapper">
            <button class="navbar-profile-btn" id="profileMenuBtn">
                ...
                <div class="profile-info">
                    <span class="profile-name">{{ Auth::guard('livreur')->user()->name }}</span>
                    <span class="profile-role">Livreur</span>
                </div>
            ...
            <div class="modern-dropdown" id="profileDropdown">
                <div class="dropdown-user-header">
                    ...
                    <div class="dropdown-user-details">
                        <h6 class="dropdown-username">{{ Auth::guard('livreur')->user()->name }}</h6>
                ...
                <ul class="dropdown-menu-list">
                    <li>
                        <form action="{{ route('delivery.logout') }}" method="GET" style="margin:0;">
                            @csrf
...
<style>
    /* ========== SYNCED MODERN NAVBAR STYLES FOR LIVREUR ========== */
    .custom-navbar {
        background: #ffffff;
