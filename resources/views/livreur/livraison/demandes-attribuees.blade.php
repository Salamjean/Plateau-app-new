...
<div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3" style="margin: 0 25px">
        <h4 style="color: var(--primary-color);">
            <i class="fas fa-clipboard-check mr-2"></i> Les colis que doit livrer {{Auth::guard('livreur')->user()->name.' '.Auth::guard('livreur')->user()->prenom}}
        </h4>
        <div>
            <span class="badge badge-pill mr-2" style="background-color: var(--secondary-color); color: white;padding:5px; border:2px solid var(--primary-color)">
