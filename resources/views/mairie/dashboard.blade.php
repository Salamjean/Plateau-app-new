                    ...
                    <div class="dashboard-card p-4">
                        ...
                        <ul class="nav nav-tabs" id="recentTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="naissances-tab" data-bs-toggle="tab"
                                    data-bs-target="#naissances" type="button" role="tab"
                                    style="color:#1977cc">Naissances</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="deces-tab" data-bs-toggle="tab" data-bs-target="#deces"
                                    type="button" role="tab" style="color:#6c757d">Décès</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="mariages-tab" data-bs-toggle="tab" data-bs-target="#mariages"
                                    type="button" role="tab" style="color:#ff0000">Mariages</button>
                            </li>
                        </ul>
