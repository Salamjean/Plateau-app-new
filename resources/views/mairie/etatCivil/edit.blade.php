        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card shadow-lg border-0 rounded-20">
                <div class="card-header py-4 text-center bg-gradient-primary rounded-top-20">
                    <h2 class="mb-0 fw-bold text-white"><i class="fas fa-home me-2 text-white"></i>Modifier les informations d'État Civil</h2>
                    <p class="mb-0 mt-2 opacity-75 text-white">Formulaire d'enregistrement par la Mairie</p>
                </div>

                <div class="card-body px-4 px-md-5 py-4">
                     <form method="POST" action="{{ route('etat-civil.update', $etatCivil->id) }}" enctype="multipart/form-data" id="editForm">
                        @csrf
                        @method('PUT')
                        <!-- Progress bar -->
                        <div class="mb-5">
                        ...
                        <div class="step-content" id="step1">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end" id="name_respo" name="name_respo" 
                                               value="{{ old('name_respo', $etatCivil->name_respo) }}" readonly 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end" id="contact" name="contact" 
                                               value="{{ old('contact', $etatCivil->contact) }}" required 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control rounded-end" id="commune" name="commune" 
                                               value="{{ old('commune', $etatCivil->commune) }}" required 
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('mairie.state.index') }}" class="btn btn-outline-secondary">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="file-upload-container text-center">
                                        ...
                                        <div id="file-preview" class="mt-3 d-none">
                                            <p class="fw-medium">Nouvelle photo:</p>
                        ...
                        <div class="step-content d-none" id="step3">
                            ...
                            <div class="confirmation-summary bg-light rounded-15 p-4 mb-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="fw-medium">Nom du service:</p>
...
<style>
    ...
    .btn-primary:hover {
        background: linear-gradient(135deg, #3774a9 0%, #3d79ae 100%);
    ...
    .btn-success:hover {
        background: linear-gradient(135deg, #3b77ab 0%, #316b9e 100%);
        transform: translateY(-2px);
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateSummary() {
            document.getElementById('summary-name').textContent = document.getElementById('name_respo').value || '-';
