        ...
        <div class="navbar-left">
            ...
            <div class="navbar-brand">
                ...
                <div class="brand-text">
                    <h1 class="brand-title">Mairie du Plateau</h1>
                    <span class="brand-subtitle">Espace Municipal</span>
                </div>
            </div>
        </div>
            ...
            <div class="navbar-profile-wrapper">
                <button class="navbar-profile-btn" id="profileMenuBtn">
                    ...
                    <div class="profile-info">
                        <span class="profile-name">{{ Auth::guard('mairie')->user()->name }}</span>
                ...
                <div class="modern-dropdown" id="profileDropdown">
                    <div class="dropdown-user-header">
                        ...
                        <div class="dropdown-user-details">
                            <h6 class="dropdown-username">{{ Auth::guard('mairie')->user()->name }}</h6>
                            <p class="dropdown-useremail">{{ Auth::guard('mairie')->user()->email }}</p>
                        </div>
                    </div>
                    <div class="dropdown-divider"></div>
                    <ul class="dropdown-menu-list">
                        <li>
                            <a href="{{ route('mairie.logout') }}" class="dropdown-item logout-item">
