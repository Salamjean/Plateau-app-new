      ...
      <div class="menu-button-container menu-profile d-none d-md-block">
        <button class="mdc-button mdc-menu-button">
          <span class="d-flex align-items-center">
            <span class="figure">
              <a class="navbar-brand brand-logo-mini" href="{{route('mairie.dashboard')}}"><img
                  src="{{asset('assets/assets/img/logo plateau.png')}}" alt="logo" width="40px" /></a>
            </span>
            <span class="user-name" style="color: white; font-size:20px; font-weight:bold">Mairie :
              {{Auth::guard('mairie')->user()->name}} </span>
          </span>
        </button>
