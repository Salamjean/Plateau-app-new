<aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open" style="background-color: #1f4083">
    <div class="mdc-drawer__header">
        <a href="{{ route('mairie.dashboard') }}" class="brand-logo">
            <img src="{{ asset('assets/assets/img/logo plateau.png') }}" alt="Logo par défaut"
    ...
    <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
            <nav class="mdc-list mdc-drawer-menu">
                    ...
                    <div class="mdc-expansion-panel" id="ui-sub-menu">
                        <nav class="mdc-list mdc-drawer-submenu">
                            <div class="mdc-list-item mdc-drawer-item">
                                ...
                                @if ($hasEtatCivil)
                                    <a class="mdc-drawer-link disabled" href="javascript:void(0)"
                                        style="color: #ccc; pointer-events: none; cursor: not-allowed;">
                                        Ajout du service
                                    </a>
                                @else
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    ...
                    <div class="mdc-expansion-panel" id="sample-page-submenu">
                        <nav class="mdc-list mdc-drawer-submenu">
                            <div class="mdc-list-item mdc-drawer-item">
                                @php
                                    $hasFinance = \App\Models\Finance::where(
                                        'mairie_id',
                                        Auth::guard('mairie')->user()->id,
                                    )->exists();
                                @endphp
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{ route('mairie.timbres.index') }}">
                        <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon"
                            aria-hidden="true">local_activity</i>
                        Ventes de timbres
                    </a>
                </div>
</aside>
