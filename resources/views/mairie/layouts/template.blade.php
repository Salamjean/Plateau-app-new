...
<head>
    ...
    <!-- Mairie Global Color Theme -->
    <link rel="stylesheet" href="{{ asset('css/mairie-global.css') }}">
...
<body>
    ...
    <div class="body-wrapper">
        <!-- Custom Sidebar -->
        @include('mairie.layouts.sidebar_new')
        <!-- End Sidebar -->
        <div class="main-wrapper" style="margin-left: 260px;">
