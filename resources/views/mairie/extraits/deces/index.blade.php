...
@section('content')
    ...
    <head>
        ...
        <title>Demande d'acte de deces</title>
        ...
        <div class="container-fluid px-4 py-4">
            ...
            <div class="dashboard-header p-4 mb-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="h3 mb-2">Demande d'acte de deces</h1>
                        <p class="mb-0">Gérez et suivez toutes les demandes d'actes de deces de votre commune</p>
                    </div>
            ...
            <div class="filter-section mb-4">
                <form method="GET" action="{{ route('mairie.request.death') }}" class="filter-form">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2 d-flex align-items-end">
                            ...
                            @if (request()->has('etat') || request()->has('type') || request()->has('livraison'))
                                <a href="{{ route('mairie.request.death') }}" class="btn btn-outline-secondary ms-2">
                                ...
                                @forelse($deces as $dece)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            @else
                                                <span class="badge bg-secondary text-white">Non spécifié</span>
                                            @endif
                                        </td>
                                        <td style="text-align: center">
                                            @if ($dece->agent)
                                                <div class="fw-bold text-primary">
                                                    <i class="fas fa-user-check me-1"></i> {{ $dece->agent->name }}
                                                </div>
                                            @else
                                        ...
                                        <td style="text-align: center">
                                            <div class="text-muted">
                                                {{ \Carbon\Carbon::parse($dece->created_at)->format('d/m/Y') }}
                                            </div>
                                            <small class="text-muted">
                                                {{ \Carbon\Carbon::parse($dece->created_at)->format('H:i') }}
                                            </small>
                                        </td>
                                        <td style="text-align: center">
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            @elseif($dece->statut_livraison == 'en cours')
