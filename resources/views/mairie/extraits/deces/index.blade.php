...
<head>
    ...
    <title>Demandes d'extrait de deces</title>
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="dashboard-header p-4 mb-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="h3 mb-2">Demandes d'extrait de deces</h1>
                    <p class="mb-0">Gérez et suivez toutes les demandes d'extrait de deces de votre commune</p>
                </div>
        ...
        <div class="table-container mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="text-muted">
                    Affichage de <strong>{{ $deces->firstItem() }}</strong> à <strong>{{ $deces->lastItem() }}</strong> sur <strong>{{ $deces->total() }}</strong> résultats
                </div>
