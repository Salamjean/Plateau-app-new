        ...
        <div class="container-fluid px-4 py-4">
            ...
            <div class="dashboard-header p-4 mb-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="h3 mb-2">Demande d'acte de mariage</h1>
                        <p class="mb-0">Gérez et suivez toutes les demandes d'actes de mariages de votre commune</p>
                    </div>
            ...
            <div class="filter-section mb-4">
                <form method="GET" action="{{ route('mairie.request.wedding') }}" class="filter-form">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="type" class="form-select">
                                ...
                                <option value="integrale" {{ request('type') == 'integrale' ? 'selected' : '' }}>Copie
                                    Integrale</option>
                                <option value="groupee" {{ request('type') == 'groupee' ? 'selected' : '' }}>Simple +
                                    Intégrale</option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-2">
                        ...
                        <div class="col-md-3 mb-2 d-flex align-items-end">
                            ...
                            @if (request()->has('etat') || request()->has('type') || request()->has('livraison'))
                                <a href="{{ route('mairie.request.wedding') }}" class="btn btn-outline-secondary ms-2">
                                ...
                                @forelse($mariages as $mariage)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            @else
                                                {{-- Ancien comportement si type est null --}}
                                                @if ($mariage->nomEpoux == null)
                                                    <span class="badge badge-normal">
                                                        <i class="fas fa-clock me-1"></i> Copie Simple
                                                    </span>
                                                @else
                                        ...
                                        <td style="text-align: center">
                                            @if ($mariage->agent)
                                                <div class="fw-bold text-primary">
                                                    <i class="fas fa-user-check me-1"></i> {{ $mariage->agent->name }}
                                                </div>
                                            @else
