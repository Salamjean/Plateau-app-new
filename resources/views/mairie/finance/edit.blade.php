        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card shadow-lg border-0 rounded-20">
                ...
                <div class="card-body px-4 px-md-5 py-4">
                     <form method="POST" action="{{ route('finance.update', $etatCivil->id) }}" enctype="multipart/form-data" id="editForm">
                        @csrf
                        @method('PUT')
                        <!-- Progress bar -->
                        <div class="mb-5">
                        ...
                        <div class="step-content" id="step1">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('mairie.finance.index') }}" class="btn btn-outline-secondary">
...
<style>
    ...
    .btn-primary:hover {
        background: linear-gradient(135deg, #367dbc 0%, #417aac 100%);
    ...
    .btn-success:hover {
        background: linear-gradient(135deg, #3e6281 0%, #316ea3 100%);
        transform: translateY(-2px);
