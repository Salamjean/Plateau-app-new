...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center" data-label="Actions">
                                        ...
                                        <button class="btn-action btn-icon" style="background-color: #17a2b8; cursor: pointer;"
                                            data-task="{{ json_encode($naissance) }}"
    ...
    <script>
        ...
        function showRequestDetails(naissanceOrElement) {
            ...
            if (naissanceOrElement && (naissanceOrElement.dataset || (naissanceOrElement.getAttribute && naissanceOrElement.getAttribute('data-task')))) {
                ...
                didOpen: () => {
                    ...
                    tabs.forEach(function(t) {
                        t.addEventListener('click', function() {
                            ...
                            document.querySelectorAll('#dpTabsN ~ .dp-panel').forEach(function(p) { p.classList.remove('dp-active'); });
