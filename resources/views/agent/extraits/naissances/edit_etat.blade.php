...
<div class="dashboard-container">
 ...
 <div class="page-title">
   ...
   <div class="page-actions">
     <a href="{{ route('agent.demandes.naissance.index') }}" class="btn-action">
   ...
   <div class="info-card">
     ...
     <div class="info-grid">
       ...
       <div class="info-item">
         ...
         <span class="info-value">{{ $naissance->created_at->format('d/m/Y à H:i') }}</span>
       </div>
       <div class="info-item">
       ...
       @if($naissance->etat == 'rejetée' && $naissance->motif_de_rejet)
       <div class="info-item info-item-full">
         <span class="info-label">Motif de Rejet (ancien)</span>
         <span class="info-value" style="white-space: pre-wrap;">{{ $naissance->motif_de_rejet }}</span>
       </div>
       @endif
     </div>
   </div>

   <form action="{{ route('agent.demandes.naissance.update', $naissance->id) }}" method="POST" id="update-etat-form">
     @csrf
     @method('POST')
