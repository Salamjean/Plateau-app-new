...
@section('content')
    ...
    <script>
        ...
        function showRequestDetails(mariageOrElement) {
            ...
            if (mariageOrElement && (mariageOrElement.dataset || (mariageOrElement.getAttribute && mariageOrElement.getAttribute('data-task')))) {
                ...
                didOpen: () => {
                    ...
                    tabs.forEach(function(t) {
                        t.addEventListener('click', function() {
                            ...
                            document.querySelectorAll('#dpTabsM ~ .dp-panel').forEach(function(p) { p.classList.remove('dp-active'); });
