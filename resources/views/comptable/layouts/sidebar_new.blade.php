<aside class="custom-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Vente de timbre -->
        <a href="{{ route('timbre.create') }}"
            class="sidebar-link {{ request()->routeIs('timbre.create') ? 'active' : '' }}" title="Vente de timbre">
            <i class="material-icons">shopping_cart</i>
            <span>Vente de timbre</span>
        </a>

        <!-- Demande en ligne -->
        <a href="{{ route('comptable.demandes.index') }}"
            class="sidebar-link {{ request()->routeIs('comptable.demandes.index') ? 'active' : '' }}"
        ...
        <a href="{{ route('comptable.timbre.history') }}"
            ...
            <span>Historique de ventes</span>
        </a>
    </nav>
</aside>
