...
/**
 * Crée la table `deces_groupes` pour les demandes groupées d'actes de décès.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('deces_groupes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deces_groupes');
    }
};
