...
class SendEmailToPosteForPasswordResetNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Plateau-Apps : Demande de mise à jour de mot de passe (Service de Livraison)')
            ->from('infos@plateau-apps.com', 'Plateau-Apps')
            ->view('emails.poste_password_reset', [
                'code' => $this->code,
                'email' => $this->email,
