...
class RendezVousController extends Controller
{
    ...
    public function store(Request $request)
    {
       $validated = $request->validate([
            ...
            'date_naissance_epoux.before' => 'L\'époux doit avoir au moins 18 ans.',
            'date_naissance_epouse.before' => 'L\'épouse doit avoir au moins 18 ans.',
