...
class AgentMariageGroupeController extends Controller
{
    ...
    private function rejeterGroupe(MariageGroupe $groupe, array $decisions, array $motifs, ?string $motifGlobal, $agent): void
    {
        ...
        if ($user) {
            ...
            $message = "Bonjour {$user->name}, votre demande groupée d'extraits de mariage (Réf: {$groupe->reference}) a été rejetée. Veuillez consulter l'application pour plus de détails.";
            try {
