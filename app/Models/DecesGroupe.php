...
/**
 * Demande groupée d'actes de décès : panier contenant N actes (simple/intégral)
 * pour des défunts potentiellement différents.
 */
class DecesGroupe extends Model
{
    protected $table = 'deces_groupes';
    ...
    {
        return $this->hasMany(Deces::class, 'groupe_id')->orderBy('position_in_groupe');
    }
    ...
    public static function generateReference(?string $commune = null): string
    {
        ...
        return 'GRD' . $rand . $next . $communeInitiale . $annee;
    }
}
